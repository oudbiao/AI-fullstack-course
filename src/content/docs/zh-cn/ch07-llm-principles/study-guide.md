...
| `gpu_train_log.txt` | [7.4.5 租 GPU 训练手搓 GPT-2](/zh-cn/ch07-llm-principles/ch04-pretraining/04-rent-gpu-gpt2-lab/) 的 `device: cuda` 训练日志 |
...
手搓记录：mini GPT-2 GPU 训练日志、环境信息和生成样例

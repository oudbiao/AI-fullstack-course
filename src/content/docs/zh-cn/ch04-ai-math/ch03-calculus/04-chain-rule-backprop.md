...
![反向传播链式法则桥梁图](/img/course/ch04-backprop-chain-rule-training-bridge.webp)
...
![链式法则计算示例分步图](/img/course/ch04-chain-rule-calculation-example.webp)
...
![多层链式法则路径图](/img/course/ch04-chain-rule-multilayer.webp)
...
![前向传播保存中间值示意图](/img/course/ch04-chain-rule-forward-pass.webp)

**前向传播**就是“从输入开始，算到预测，再算到损失”。在这个小网络里，模型大小不是重点，重点是养成保存中间值的习惯：
...
![反向传播把梯度从损失传回参数](/img/course/ch04-chain-rule-backward-pass.webp)
...
![用梯度和学习率更新参数](/img/course/ch04-chain-rule-parameter-update.webp)
...
![小神经网络完整训练循环](/img/course/ch04-chain-rule-full-training-loop.webp)

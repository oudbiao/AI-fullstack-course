---
title: "5.6.4 Project 3: User Segmentation Analysis (Clustering Problem)"
...
head:
  - tag: meta
    attrs:
      name: keywords
      content: "user segmentation, clustering, RFM, K-Means, dimensionality reduction, customer value analysis"
---

...
head:
  - tag: meta
    attrs:
      name: keywords
      content: "線形代数ガイド, AI 数学ガイド, ベクトル, 行列, 固有値, PCA"
---
...
| 順番 | 読む | まず見ること |
|---|---|---|
| 1 | [4.1.2 ベクトル](/ja/ch04-ai-math/ch01-linear-algebra/01-vectors/) | 対象 -> ベクトル、長さ、内積、コサイン類似度 |
| 2 | [4.1.3 行列](/ja/ch04-ai-math/ch01-linear-algebra/02-matrices/) | バッチデータ、行列積、`X @ W + b` |
| 3 | [4.1.4 固有値と固有ベクトル](/ja/ch04-ai-math/ch01-linear-algebra/03-eigenvalues/) | 特別な方向、PCA の直感 |
| 4 | [4.1.5 ベクトル空間](/ja/ch04-ai-math/ch01-linear-algebra/04-vector-spaces/) | 基底、次元、線形変換 |

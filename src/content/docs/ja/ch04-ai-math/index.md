...
| ページ | 手を動かすこと | 残す証拠 |
|---|---|---|
| [4.1 線形代数](/ja/ch04-ai-math/ch01-linear-algebra/00-roadmap/) | ベクトル、行列、内積、ノルム、コサイン類似度で例を比較する | ベクトル類似度の計算 1 件 |
| [4.2 確率と統計](/ja/ch04-ai-math/ch02-probability/00-roadmap/) | 不確かさ、分布、平均、分散、エントロピー、損失をシミュレーションする | 確率またはエントロピーのメモ |
| [4.3 微積分と最適化](/ja/ch04-ai-math/ch03-calculus/00-roadmap/) | 導関数、勾配、学習率、勾配降下を追跡する | パラメータ更新表 |
| [4.4 フル数学ワークショップ](/ja/ch04-ai-math/hands-on-math-workshop/) | ベクトル類似度、確率、エントロピー/損失、勾配降下を 1 つの実行スクリプトにつなげる | `ch04_math_workshop_evidence/` |
...
- [4.4 フル数学ワークショップ](/ja/ch04-ai-math/hands-on-math-workshop/) を実行し、生成ファイルを説明できますか？

印刷用のチェックリストが必要なときは、[4.0 学習ガイドとタスクリスト](/ja/ch04-ai-math/study-guide/) を使ってください。次の章では、この数学直感を sklearn のモデル学習と評価に落とし込みます。

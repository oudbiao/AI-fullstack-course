...
1. [4.1 線形代数](/ja/ch04-ai-math/ch01-linear-algebra/00-roadmap/): ベクトル、行列、内積、ノルム、コサイン類似度で例を比較する。
2. [4.2 確率と統計](/ja/ch04-ai-math/ch02-probability/00-roadmap/): 不確かさ、分布、平均、分散、エントロピー、損失をシミュレーションする。
3. [4.3 微積分と最適化](/ja/ch04-ai-math/ch03-calculus/00-roadmap/): 導関数、勾配、学習率、勾配降下を追跡する。
4. [4.4 フル数学ワークショップ](/ja/ch04-ai-math/hands-on-math-workshop/): 1 つの実行スクリプトで全体をつなげ、`ch04_math_workshop_evidence/` を残す。

...
3. 要件が頻繁に変わると、微調整した振る舞いはすぐ古くなります。prompt、検索ルール、workflow ロジックを変えるほうが速く、監査もしやすいです。
4. 微調整は、学習データ内のパターンを強めます。方法名が full finetuning、LoRA、その他の PEFT であることより、明確で一貫し、代表性のあるデータのほうが重要です。

...
text = "今週土曜 19:30 に Tencent Meeting で AI アプリ初学者向けの RAG 入門ライブ配信を開催します。Presenter Zhang が登壇します。"
...
```text
{'time': '19:30', 'platform': 'Tencent Meeting', 'topic': 'RAG 入門', 'speaker': 'Presenter Zhang', 'audience': 'AI アプリ初学者'}
```
...
examples = [
    {
        "text": "今週土曜 19:30 に Tencent Meeting で RAG 入門ライブ配信を開催します。Presenter Zhang が登壇します。",
        "gold": {"time": "19:30", "platform": "Tencent Meeting", "topic": "RAG 入門", "speaker": "Presenter Zhang"},
    },
    {
        "text": "日曜 10:00 に Zoom で評価指標の解説を行います。Presenter Li が登壇します。",
        "gold": {"time": "10:00", "platform": "Zoom", "topic": "評価指標", "speaker": "Presenter Li"},
    },
]
...
```text
{'text': '今週土曜 19:30 に Tencent Meeting で RAG 入門ライブ配信を開催します。Presenter Zhang が登壇します。', 'predicted': {'time': '19:30', 'platform': 'Tencent Meeting', 'topic': 'RAG 入門', 'speaker': 'Presenter Zhang'}}
{'text': '日曜 10:00 に Zoom で評価指標の解説を行います。Presenter Li が登壇します。', 'predicted': {'time': '10:00', 'platform': 'Zoom', 'topic': '評価指標', 'speaker': 'Presenter Li'}}
field_accuracy = 1.0
```
...
1 つ目の誤解は、成功例だけを見せてフィールド単位の評価をしないことです。2 つ目の誤解は、JSON schema が安定しておらず、後続のプログラムで使えないことです。3 つ目の誤解は、境界の問題を無視することです。たとえば「Presenter Zhang が北京大学で共有します」のような文では、北京大学が場所にも組織にも見える場合があります。4 つ目の誤解は、LLM の出力をそのままデータベースに入れてしまい、検証をしないことです。

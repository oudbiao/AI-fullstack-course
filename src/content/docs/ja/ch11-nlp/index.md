...
![テキストから NLP タスクへのパイプライン](/img/course/ch11-text-to-task-pipeline-ja.webp)
...
| 11.7 | ステージプロジェクト | [11.7.6 実践：再現可能な NLP ミニパイプラインを作る](/ja/ch11-nlp/ch07-projects/05-hands-on-nlp-workshop/) を動かす | データファイル、指標、抽出出力、失敗レポート |
...
印刷用チェックリストは [11.0 学習チェックリスト](/ja/ch11-nlp/study-guide/) を使ってください。プロジェクトから始めたい場合は [11.7.6 実践：再現可能な NLP ミニパイプラインを作る](/ja/ch11-nlp/ch07-projects/05-hands-on-nlp-workshop/) へ進みます。

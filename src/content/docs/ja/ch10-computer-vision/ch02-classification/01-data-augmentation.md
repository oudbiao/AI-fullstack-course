...
![データ拡張の不変性と意味的リスクの図](/img/course/ch10-augmentation-invariance-risk-map-ja.webp)
...
3. Mixup は画像だけでなくラベルも混ぜます。通常の augmentation は、1 枚の画像を変形しながらラベルはそのまま保つことが多いです。
4. 検証性能が下がったら、まず拡張後のサンプルを可視化します。よくある原因は強すぎる、または意味的に間違った augmentation ですが、弱すぎる場合は過学習が残ることもあります。

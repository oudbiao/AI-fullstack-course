...
![Agent 準備チェック結果図](/img/course/ch09-production-readiness-check-result-map-ja.webp)
...
![Agent 本番準備、段階的リリース、ロールバック図](/img/course/ch09-production-readiness-canary-rollback-map-ja.webp)
...
1. 今の自分のプロジェクトに合わせて、準備設定表を作り、何が足りないか確認してみましょう。

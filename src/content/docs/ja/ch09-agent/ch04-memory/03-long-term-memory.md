...
```text
{'preferred_doc_format': 'word', 'preferred_style': '簡潔なチェックリスト', 'preferred_language': 'zh/en/ja', 'default_audience': 'frontline support', 'prefer_source_refs': True}
```

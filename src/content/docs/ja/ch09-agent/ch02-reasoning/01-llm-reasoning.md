...
---
![LLM 推論と中間状態チェックポイント図](/img/course/ch09-reasoning-state-checkpoint-map-ja.webp)
...
3. 例：ポリシーを検索してから資格を判断する、データ列を確認してから分析方法を選ぶ、ツールを呼び出してからその結果を要約する。
4. ツールは行動の手段を提供するだけです。推論は、いつツールを使うか、observation をどう解釈するか、複数のステップをどう目標へつなげるかを決めます。

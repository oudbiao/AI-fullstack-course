...
1. [1.1.1 Terminal and command line](/ch01-tools/ch01-terminal/01-why-cli/): run `pwd`, `ls`, and `cd`; keep a short command log.
2. [1.1.2 Basic terminal operations](/ch01-tools/ch01-terminal/02-basic-operations/): create, move, inspect, and remove files; keep a folder screenshot or terminal output.
3. [1.1.3 Package managers](/ch01-tools/ch01-terminal/03-package-managers/): check how your system installs tools; keep tool version notes.

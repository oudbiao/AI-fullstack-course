...
1. Can I understand more code than last month?
2. Can I modify examples instead of only copying?
3. Can I explain one concept more clearly?

If yes, you are progressing.

## Three abilities to strengthen first

1. Python and debugging.
2. Data processing and visualization.
3. Minimal closed-loop project thinking.

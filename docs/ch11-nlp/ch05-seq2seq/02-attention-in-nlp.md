---
title: "11.5.3 Attention Mechanism in NLP"
sidebar_position: 2
...
## Why Does Seq2Seq Need Attention?

### Fixed-Length Encoding Easily Loses Information
...
### The Decoder Should Focus on Different Things at Different Time Steps
...
## Run a Minimal Attention Example First
...
### Why Does This Already Show the Essence of Attention?
...
### For a Beginner Learning Attention for the First Time, What Three Things Should You Remember First?
...
### Another Minimal Example of Alignment Between an Output Word and Input Words
...
## Why Does Attention Significantly Improve Seq2Seq?

### It Relieves the Information Bottleneck

The input no longer has to be passed to the decoder through only one fixed vector.

### It Makes Input-Output Alignment More Natural
...
### It Is Also the Bridge from Classic Seq2Seq to Transformer

Later, Transformer extends attention more thoroughly,
but the intuitive foundation in this section is the same.

### When Learning This Section for the First Time, the Most Worthwhile Thing to Look at Is the Process, Not the Formula
...
### Mistake 1: Attention Is Just a Weighted Average Trick

Not quite.
It changes how the model accesses input information.

### Mistake 2: With Attention, Nothing Is Ever Lost

No.
Long sequences still remain difficult; the bottleneck is just significantly reduced.

### Mistake 3: Attention Is the Same as Transformer

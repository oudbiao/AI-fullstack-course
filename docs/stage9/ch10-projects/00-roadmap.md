...
sidebar_position: 0
description: "先建立第九阶段项目章的学习地图：研究助手、数据分析 Agent 和多 Agent 开发团队如何把规划、工具、记忆、评估和部署组织成作品集项目。"
...
第九阶段的综合项目是 Agent 主线的出口。前面章节分别讲了 Agent 的目标、规划、工具、记忆、MCP、多 Agent、评估安全和部署运维；项目章要把这些能力合成一个可演示、可复盘、可扩展的智能体系统。

...
Open `assets/scene_01.svg`, `assets/scene_02.svg`, and `assets/scene_03.svg` in your browser. They are simple SVG placeholders, but they behave like generated assets in the workflow.
...
|---|---|
| SVG placeholder | Image generation API or local image model |

...
|---|---|
| I am new | Follow chapters 1-9 |
| I already code | Skim 1-6, focus on 7-9 |
| I need a portfolio | Keep README, screenshots, logs, failures |
| I care about models | Spend more time on math, ML, DL, Transformer |

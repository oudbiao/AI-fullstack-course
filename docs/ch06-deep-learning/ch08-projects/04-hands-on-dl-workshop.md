...
![Tensor shape and data split guardrails](/img/course/ch06-hands-on-shape-split-guardrail-en.png)

### 1.1 Mental Model: One Image, One Batch, Three Splits
...
![Dataset to DataLoader batch flow](/img/course/ch06-hands-on-dataset-dataloader-batch-flow-en.png)
...
![PyTorch training loop anatomy](/img/course/ch06-hands-on-training-loop-anatomy-en.png)
...
![Deep learning output reading lab](/img/course/ch06-hands-on-output-reading-lab-en.png)
...
![PyTorch small rerun experiment loop](/img/course/ch06-hands-on-rerun-experiment-loop-en.png)
...
### 7.1 Practice a One-Variable Rerun

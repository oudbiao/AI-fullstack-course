...
- 2026-05-19: ch08 QA report is written and all 123 accepted candidates have been converted to official same-stem WebP files in `static/img/course/`. Post-conversion dimension check passed for all 123. Run the required validators/build and commit the ch08 image refinement before starting ch09 images.

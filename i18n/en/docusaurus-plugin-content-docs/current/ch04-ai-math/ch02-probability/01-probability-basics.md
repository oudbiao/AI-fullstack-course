...
![Probability distribution and Bayes update diagram](/img/course/probability-distribution-map.png)
...
![Probability and Bayes update flowchart](/img/course/ch04-probability-bayes-update-flow.png)

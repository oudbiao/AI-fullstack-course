...
![Gradient descent path diagram](/img/course/gradient-descent-path.png)
...
![Gradient descent iteration loop diagram](/img/course/ch04-gradient-descent-iteration-loop.png)

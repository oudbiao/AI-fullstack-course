...
![ColumnTransformer and Pipeline workflow diagram](/img/course/column-transformer-pipeline.png)
...
![ColumnTransformer Pipeline diagram for real tabular data](/img/course/ch05-columntransformer-real-table-pipeline.png)

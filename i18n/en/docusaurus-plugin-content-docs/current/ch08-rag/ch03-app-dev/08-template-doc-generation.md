...
![Word PPT template generation pipeline](/img/course/template-doc-generation-pipeline.png)
...
![Structured courseware to template rendering diagram](/img/course/ch08-template-schema-to-render-map.png)

...
![RAG optimization layered troubleshooting funnel diagram](/img/course/ch08-rag-optimization-debug-funnel-map.png)
...
![RAG optimization experiment feedback loop diagram](/img/course/ch08-rag-experiment-eval-loop-map.png)

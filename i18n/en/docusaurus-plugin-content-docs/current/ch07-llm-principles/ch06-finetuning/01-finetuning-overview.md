...
![Overall finetuning and alignment flowchart](/img/course/finetuning-alignment-pipeline.png)
...
![Decision map for choosing a solution before finetuning](/img/course/ch07-finetune-decision-rag-prompt-peft-map.png)

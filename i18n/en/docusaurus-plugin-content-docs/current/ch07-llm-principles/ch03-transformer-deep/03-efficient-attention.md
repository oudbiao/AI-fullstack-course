...
![Efficient attention bottleneck distribution diagram](/img/course/ch07-efficient-attention-bottleneck-map.png)
...
![KV cache comparison of MHA/GQA/MQA](/img/course/ch07-kv-cache-mqa-gqa-map.png)

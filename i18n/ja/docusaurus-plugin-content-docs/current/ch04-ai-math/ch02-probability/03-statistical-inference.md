...
![最尤推定の尤度曲線図](/img/course/mle-likelihood-curve-ja.png)
...
![統計推論のデータからパラメータへの図](/img/course/ch04-statistical-inference-data-to-parameter-ja.png)
...
![p 値と帰無仮説分布の図解](/img/course/ch04-pvalue-null-distribution-ja.svg)

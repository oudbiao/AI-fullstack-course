...
![情報エントロピーと不確実性の図](/img/course/information-entropy-uncertainty-ja.png)
...
![情報理論から損失関数への地図](/img/course/ch04-information-theory-loss-map-ja.png)
...
### 2.1.1 エントロピーでまず覚えるべきなのは、定義よりも「混乱の度合い」
...
### 2.3 可視化：コインのエントロピーが p によってどう変わるか
...
良い予測     → 交差エントロピー損失 ≈ 0.1643
悪い予測     → 交差エントロピー損失 ≈ 0.6365
完全に間違い → 交差エントロピー損失 ≈ 2.3026
```

### 3.4 可視化：予測の正確さ vs 損失
...
### 3.6 単一サンプルの交差エントロピーの最小例をもう一度見る
...
### 4.1.1 なぜ KLダイバージェンス は少し分かりにくいのか？
...
### 4.3 可視化：分布の差が大きくなると KLダイバージェンス はどう変わるか
...
- [第5章のトップページ](../../ch05-machine-learning/index.md)
- [ロジスティック回帰](../../ch05-machine-learning/ch02-supervised/02-logistic-regression.md)
- [評価指標](../../ch05-machine-learning/ch04-evaluation/01-metrics.md)

...
![確率分布ファミリーの比較図](/img/course/distribution-family-comparison-ja.png)
...
![確率分布のランダム現象マップ](/img/course/ch04-distribution-random-world-map-ja.png)
...
- [統計的推論の基礎](./03-statistical-inference.md)

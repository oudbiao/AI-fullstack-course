...
![行列のバッチ変換フローチャート](/img/course/ch04-matrix-batch-transform-flow-ja.webp)
...
![行列積のサイズルール図解](/img/course/ch04-matrix-multiplication-shape-rule-ja.webp)
...
- [4.1.4 固有値と固有ベクトル](./03-eigenvalues.md)

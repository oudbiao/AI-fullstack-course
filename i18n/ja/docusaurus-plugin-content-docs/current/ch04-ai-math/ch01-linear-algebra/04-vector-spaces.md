...
![ベクトル空間の基底ベクトルが張るイメージ](/img/course/vector-space-basis-span-ja.png)
...
![ベクトル空間の高次理解図](/img/course/ch04-vector-space-high-level-map-ja.png)
...
![SVD の直感：方向、強さ、再構成](/img/course/ch04-svd-intuition-vertical-ja.png)

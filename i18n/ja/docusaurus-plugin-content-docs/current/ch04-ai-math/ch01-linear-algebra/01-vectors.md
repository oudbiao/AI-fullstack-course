---
title: "1.2 ベクトル：AI の世界の基本単位"
sidebar_position: 1
description: "ベクトルの直感的な意味を理解し、内積やコサイン類似度を身につけ、NumPy と Matplotlib でベクトル演算を実践する"
keywords: [ベクトル, 内積, コサイン類似度, NumPy, 線形代数, AI数学]
---

# ベクトル：AI の世界の基本単位

![ベクトルの内積とコサイン類似度の幾何図](/img/course/vector-dot-cosine-geometry-ja.png)
...
![ベクトルの AI における意味の地図](/img/course/ch04-vector-ai-meaning-map-ja.png)
...
**解釈**：Alice と Bob の好みはとても似ています（0.98 は 1 にかなり近い）。一方で、Charlie は 2 人と好みがかなり違います。これがレコメンドシステムの基本です。つまり、好みの近い人を見つけて、その人が好きなものをおすすめするのです。

### 4.3 AI におけるコサイン類似度の応用
...
### 4.5 もっとも小さな検索例：3 つの候補から最も近いものを探す

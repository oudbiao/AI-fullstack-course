...
![微積分と最適化学習マップ](/img/course/ch04-calculus-roadmap-vertical-ja.png)

学習の流れです。

![微積分と最適化セクション関係図](/img/course/ch04-calculus-training-flow-ja.png)
...
| 2 | [4.3.3 偏導関数と勾配](./02-partial-gradients.md) | 複数のパラメータが一緒に変わる |
| 3 | [4.3.4 勾配降下](./03-gradient-descent.md) | 更新ループ、学習率、loss 曲線 |
| 4 | [4.3.5 バックプロパゲーション](./04-backpropagation.md) | 連鎖律、`loss.backward()` の直感 |

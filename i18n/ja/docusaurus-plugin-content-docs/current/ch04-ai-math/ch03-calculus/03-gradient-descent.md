...
![勾配降下の反復ループ図](/img/course/ch04-gradient-descent-iteration-loop.png)
...
### 3.1 学習率が大きすぎる場合 vs 小さすぎる場合

### 3.1.1 初心者により分かりやすい例え
...
- [連鎖律とバックプロパゲーションの予習](./04-chain-rule-backprop.md)

...
![勾配等高線方向場図](/img/course/gradient-contour-field.png)
...
![偏導数と勾配のつまみ調整図](/img/course/ch04-gradient-parameter-knobs-map.png)
...
### 3.3 最小の「勾配でパラメータを更新する」例をもう一度見る
...
### 3.5 よくある間違い：勾配の向きに沿って損失を更新してしまう

...
![連鎖律の計算例を段階的に示す図](/img/course/ch04-chain-rule-calculation-example-ja.png)
...
![多段の連鎖律の経路図](/img/course/ch04-chain-rule-multilayer-ja.png)
...
![順伝播で中間値を保存する図](/img/course/ch04-chain-rule-forward-pass-ja.png)
...
![逆伝播で損失からパラメータへ勾配を戻す図](/img/course/ch04-chain-rule-backward-pass-ja.png)
...
![勾配と学習率でパラメータを更新する図](/img/course/ch04-chain-rule-parameter-update-ja.png)
...
![小さなニューラルネットワークの完全な学習ループ](/img/course/ch04-chain-rule-full-training-loop-ja.png)

...
![LLM アプリと RAG メインビジュアル](/img/course/ch08-rag-engineering-ja.png)
...
## 8.0.1 まず RAG アプリのループを見る

![RAG アプリループ](/img/course/ch08-rag-app-loop-ja.svg)
...
## 8.0.3 最初に動かすループ：フレームワークなしの Tiny RAG
...
## 8.0.4 悪い RAG 回答をデバッグする

![RAG デバッグ階段](/img/course/ch08-rag-debug-ladder-ja.svg)

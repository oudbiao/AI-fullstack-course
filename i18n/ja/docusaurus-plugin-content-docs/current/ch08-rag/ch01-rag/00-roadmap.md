...
## 8.1.1.1 まず RAG パイプラインを見る

![LLM アプリケーションにおける RAG の位置づけを示す橋渡し図](/img/course/ch08-rag-position-bridge-ja.png)

![RAG コア章の学習順序図](/img/course/ch08-rag-core-chapter-flow-ja.png)

![RAG で資料から回答へ進むパイプライン図](/img/course/ch08-rag-data-to-answer-pipeline-ja.png)

基本ループは、文書読み込み、chunk 分割、metadata 付与、embedding、検索、rerank、context 組み立て、回答、出典引用、評価です。

## 8.1.1.2 小さな検索チェックを動かす

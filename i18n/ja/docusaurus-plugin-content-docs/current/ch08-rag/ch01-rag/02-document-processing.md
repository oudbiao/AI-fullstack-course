...
![文書解析とベクトル化のフローチャート](/img/course/document-processing-vectorization.png)
...
![Chunk サイズと overlap のトレードオフ図](/img/course/ch08-chunk-size-overlap-tradeoff-map.png)
...
![教材知識ブロックのメタデータ schema 図](/img/course/ch08-courseware-chunk-metadata-schema-map.png)

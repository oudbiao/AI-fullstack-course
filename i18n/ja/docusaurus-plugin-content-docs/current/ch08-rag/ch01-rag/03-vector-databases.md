...
![ベクトルストアのレコードとメタデータフィルタの図](/img/course/ch08-vector-record-metadata-filter-map-ja.webp)
...
![厳密検索と ANN のトレードオフ図](/img/course/ch08-ann-exact-search-tradeoff-map-ja.webp)
...
| シーン | 推奨の出発点 | 理由 |
|---|---|---|
| 学習、最小デモ | メモリ上のリスト、FAISS、Chroma | シンプルで、見えやすく、デバッグしやすい |

...
### 1.1 RAG で探したいのは「完全一致」ではなく「意味が近いもの」
...
### 1.2 ベクトルデータベースは本質的に「意味の座標」を管理している
...
### 2.1 ベクトルだけではなく、テキストやメタデータも保存する
...
### 9.1 ベクトルデータベースが自分で意味を理解していると思う

違います。  
意味の品質をまず左右するのは embedding モデルです。

### 9.2 ベクトルを保存すれば RAG は必ずうまくいくと思う

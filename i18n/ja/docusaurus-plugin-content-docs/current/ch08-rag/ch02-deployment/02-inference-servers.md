...
### 1.2 推理サービスで気にするのは「同時にどれだけのリクエストをさばけるか」
...
![推理サービスのキューとバッチ処理の図](/img/course/ch08-inference-serving-queue-batch-map.png)
...
### 6.3 初めて推理サービスを作るときの、いちばん安定した順番
...
### 9.1 単発の推論 benchmark だけを見る

本番で本当に大事なのは、全体の流量の中でどう動くかです。

### 9.2 最初から batch を大きくしすぎる

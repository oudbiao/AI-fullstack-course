...
![Function Calling ワークフロー図](/img/course/function-calling-workflow-ja.webp)
...
![Function Calling 検証と実行の閉ループ図](/img/course/ch08-function-calling-validation-dispatch-map-ja.webp)

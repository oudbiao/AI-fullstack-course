...
### 1.1 実際のアプリは、たいていモデルを 1 回呼ぶだけではないから
...
### 3.1 Prompt は「付属文」ではなく、1 つのコンポーネント
...
![LangChain コンポーネントのパイプライン図](/img/course/ch08-langchain-component-pipeline-map.png)
...
1. この `SimpleChain` に、query を検索しやすい形に書き換えるステップを 1 つ追加してみてください。

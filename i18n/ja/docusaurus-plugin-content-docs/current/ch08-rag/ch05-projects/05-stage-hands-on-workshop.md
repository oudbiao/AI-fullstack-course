---
title: "5.6 実践：第 8 章 RAG アプリ完全ワークショップ"
sidebar_position: 25
...
![第 8 章の四層学習マップ](/img/course/ch08-study-guide-four-layer-map-ja.png)
...
![RAG のデータから回答までのパイプライン](/img/course/ch08-rag-data-to-answer-pipeline-ja.png)
...
![文書解析と形式ルーティングの図](/img/course/ch08-document-parsing-format-router-map-ja.png)
...
![アシスタント会話とツール trace 図](/img/course/ch08-assistant-session-tool-trace-map-ja.png)
...
![ベクトルレコードと metadata フィルタ図](/img/course/ch08-vector-record-metadata-filter-map-ja.png)
...
![堅牢な LLM API クライアントループ図](/img/course/ch08-llm-api-robust-client-loop-map-ja.png)
...
![Function Calling の検証とディスパッチ図](/img/course/ch08-function-calling-validation-dispatch-map-ja.png)
...
![RAG レイヤー別トラブルシュート図](/img/course/ch08-rag-layer-failure-debug-map-ja.png)
...
![RAG 実験と評価ループ図](/img/course/ch08-rag-experiment-eval-loop-map-ja.png)
...
![LLM アプリプロジェクト納品ループ図](/img/course/ch08-project-delivery-loop-ja.png)

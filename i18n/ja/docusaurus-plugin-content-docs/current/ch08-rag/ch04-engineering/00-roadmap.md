...
![LLMOps trace レビュー閉ループ図](/img/course/ch08-llmops-trace-loop-ja.webp)

![Observability logs metrics trace map](/img/course/ch08-observability-logs-metrics-trace-map-ja.webp)

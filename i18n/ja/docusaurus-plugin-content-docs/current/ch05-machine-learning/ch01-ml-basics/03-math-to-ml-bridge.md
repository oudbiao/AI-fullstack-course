...
![数学から機械学習への学習マップ](/img/course/ch05-math-to-ml-training-map-ja.png)
...
![勾配降下法の4ステップ学習ループ](/img/course/ch05-gradient-descent-four-step-loop-ja.png)
...
![機械学習の数学的学習ループ漫画](/img/course/ch05-math-training-loop-comic-ja.png)
...
1. [1.4 Scikit-learn フレームワーク入門](./02-sklearn-intro.md)
2. [2.2 線形回帰](../ch02-supervised/01-linear-regression.md)
3. [4.2 評価指標](../ch04-evaluation/01-metrics.md)

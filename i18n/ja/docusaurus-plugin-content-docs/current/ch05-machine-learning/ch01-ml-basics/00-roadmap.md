---
title: "5.1.1 学習ガイド：機械学習基礎のこの章では何を学ぶのか"
sidebar_position: 0
...
# 5.1.1 学習ガイド：機械学習基礎のこの章では何を学ぶのか

![機械学習基礎の学習地図](/img/course/ml-basics-roadmap-ja.png)
...
![機械学習基礎章の関係図](/img/course/ch05-basics-chapter-flow-ja.png)
...
「なぜこれらのアルゴリズムが登場したのか」を先に整理したいなら、まず [5.1.2 機械学習の歴史的ブレイクスルーの流れ](./04-history-breakthroughs.md) を読んでください。ここでは Bayes、MLE、EM、線形モデル、決定木、SVM、ランダムフォレスト、Boosting、XGBoost、sklearn を、それぞれ対応する学習章へ割り当てていきます。

...
![機械学習モデリングの閉ループ図](/img/course/ml-modeling-loop.png)
...
![機械学習タスクの種類を判断する図](/img/course/ch05-task-type-decision-map.png)
...
![学習・検証・テストとデータ漏えいのガードレール図](/img/course/ch05-data-split-leakage-guardrail.png)

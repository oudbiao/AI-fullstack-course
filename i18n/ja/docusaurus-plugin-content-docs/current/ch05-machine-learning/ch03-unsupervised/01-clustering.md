...
![クラスタリングアルゴリズム選択フロー図](/img/course/ch05-clustering-decision-flow-ja.webp)

![クラスタリングは仮説であることを説明するマンガ](/img/course/ch05-clustering-hypothesis-comic-ja.webp)

![クラスタリングのデータ形状とアルゴリズム選択図](/img/course/ch05-clustering-shape-selection-map-ja.webp)

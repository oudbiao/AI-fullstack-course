...
![混同行列と誤りコスト図](/img/course/confusion-matrix-error-cost.png)
...
![評価指標選択フローチャート](/img/course/ch05-metrics-selection-flow.png)
...
![しきい値、ROC と PR 曲線の読み方ガイド](/img/course/ch05-threshold-roc-pr-curve-map.png)

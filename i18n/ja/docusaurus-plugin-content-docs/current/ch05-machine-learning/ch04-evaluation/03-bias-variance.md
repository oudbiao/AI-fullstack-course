...
![偏差方差トレードオフ三連図](/img/course/bias-variance-tradeoff.png)
...
![偏差方差アクション診断図](/img/course/ch05-bias-variance-action-map.png)
...
![学習曲線診断図](/img/course/ch05-learning-curve-diagnosis-map.png)

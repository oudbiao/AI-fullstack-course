...
## 5.6.1.1 まずプロジェクトループを見る

![機械学習プロジェクト実践ロードマップ](/img/course/ml-projects-roadmap-ja.png)

![機械学習プロジェクトポートフォリオループ](/img/course/ch05-projects-portfolio-loop-ja.png)
...
| 順番 | 読む | 提出するもの |
|---|---|---|
| 1 | [5.6.6 ML 実践ワークショップ](./05-hands-on-ml-workshop.md) | 完全な証拠パックの練習 |
| 2 | [5.6.2 住宅価格予測](./01-house-price.md) | 回帰 baseline と改善 |
| 3 | [5.6.3 顧客離脱予測](./02-customer-churn.md) | 分類指標としきい値の考え方 |
| 4 | [5.6.4 ユーザーセグメンテーション](./03-user-segmentation.md) | クラスタ解釈と業務ラベル |
| 5 | [5.6.5 Kaggle 実践](./04-kaggle.md) | 実際の提出フロー |

ワークショップを先に置くのは、証拠パックの型を先に見せるためです。型が見えると、大きなプロジェクトが安定します。

## 5.6.1.4 プロジェクト成果物基準

![機械学習プロジェクトレポートストーリーボード](/img/course/ch05-project-report-storyboard-ja.png)

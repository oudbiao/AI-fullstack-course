---
title: "5.2.1 学習ガイド：この章の監督学習では何を学ぶのか"
sidebar_position: 2
description: "まず監督学習の学習マップを作ろう：回帰、分類、決定木、集約学習を、どのように段階的に理解すればよいか。"
keywords: [監督学習ガイド, 線形回帰, ロジスティック回帰, 決定木, 集約学習]
---

# 5.2.1 学習ガイド：この章の監督学習では何を学ぶのか

![監督学習のロードマップ](/img/course/supervised-learning-roadmap-ja.png)
...
![監督学習の章の関係図](/img/course/ch05-supervised-chapter-flow-ja.png)

...
![決定木の分岐パス図](/img/course/decision-tree-split-path.png)
...
![決定木の学習主線図](/img/course/ch05-decision-tree-learning-flow.png)
...
![決定木の過学習と枝刈り図](/img/course/ch05-tree-pruning-overfit-map.png)

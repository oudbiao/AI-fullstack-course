...
## RNN の核心アイデア：1歩読むたびに少しずつ「記憶」を持つ
...
## RNN の入力と出力にはどんな種類があるのか？

### Many-to-one: 系列全体から1つの結果を出す
...
### Sequence-to-sequence: 1つの系列を別の系列に変換する
...
## なぜ RNN は後に LSTM / GRU や Transformer に押されていったのか？

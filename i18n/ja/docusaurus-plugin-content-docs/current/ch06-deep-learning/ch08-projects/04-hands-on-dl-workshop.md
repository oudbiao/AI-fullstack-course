...
![PyTorch shape とデータ分割のガードレール](/img/course/ch06-hands-on-shape-split-guardrail-ja.png)

### 1.1 まず持つべき見取り図：1 枚の画像、1 つの batch、3 つの分割
...
![Dataset から DataLoader への batch 処理フロー](/img/course/ch06-hands-on-dataset-dataloader-batch-flow-ja.png)
...
![PyTorch 学習ループの解剖図](/img/course/ch06-hands-on-training-loop-anatomy-ja.png)
...
![深層学習の出力ファイルを読む実験室](/img/course/ch06-hands-on-output-reading-lab-ja.png)
...
![PyTorch の小さな再実行実験ループ](/img/course/ch06-hands-on-rerun-experiment-loop-ja.png)

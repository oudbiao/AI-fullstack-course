...
![ニューラルネットワークの順伝播と逆伝播の図](/img/course/neural-network-forward-backward.png)
...
![逆伝播の誤差責任分配図](/img/course/ch06-backprop-error-responsibility-map.png)
...
![NumPy から PyTorch への学習ループ対応図](/img/course/ch06-numpy-to-pytorch-training-loop-map.png)

...
### 3.2.1 もっと分かりやすく言うと：誤差の責任を前へ分配する
...
### 5.1 この NumPy の学習ループを何度も見る価値があるのはなぜ？

...
![ニューロンから MLP への構造図](/img/course/mlp-neuron-activation.png)
...
![ニューロンの線形スコアと活性化ゲート図](/img/course/ch06-neuron-linear-activation-gate.png)
...
### 1.1.1 ディープラーニングをまだ考えなくても、ニューロンは何として捉えればいい？
...
### 2.3 パーセプトロンのこの部分で、いちばん持ち帰るべきことは？
...
![XOR における単層パーセプトロンの限界図](/img/course/ch06-xor-single-layer-limit-map.png)
...
### 3.4 学び始めの段階では、どう選ぶのがいちばん混乱しにくい？

...
### 2.3 このデータセットは単純ですが、何を学ぶには十分ですか？
...
### 9.1 モデルだけをまねして、データの shape を確認しない

画像タスクでは、shape の確認がほぼ最優先です。

### 9.2 train loss だけを見る

...
### 1.4 調参でまず覚えるべきことは、パラメータ名ではなく何か？
...
### 4.1 まず大部分を固定して、1〜2個の重要なパラメータだけを調整する
...
### 4.2 学習が安定して回るようになったら、次に汎化の調整を見る
...
### 4.3 最後に、より細かい局所探索を行う

こうすると、実験の意味が分かりやすくなります。

### 4.4 初学者がそのまま真似しやすい順番
...
### 5.1 落とし穴1：一度にたくさんのパラメータを変える

これでは結果の意味が分かりにくくなります。

### 5.2 落とし穴2：training set の結果だけを見る

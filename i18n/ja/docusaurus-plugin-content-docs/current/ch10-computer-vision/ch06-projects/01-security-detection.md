...
![防犯検知、ルール、トラッキング、アラート重複排除の図](/img/course/ch10-security-detection-alert-dedup-map-ja.png)
...
### 3.1 この例が「人を検出したらアラート」よりずっと強い理由
...
### 4.3 なぜ「アラート層の指標」は mAP よりもプロジェクト価値に近いのか？
...
### 6.1 初めてこの種のプロジェクトを作るときの、いちばん安定した進め方

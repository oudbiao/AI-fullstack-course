...
最初に動かす例としては、[実践：再現可能なビジョン・ミニパイプラインを作る](./03-hands-on-vision-workshop.md) をおすすめします。大きなプロジェクトページに入る前に、データ生成、前処理、分類、検出 box、segmentation mask、指標、失敗分析の具体的な baseline を作れます。

...
![ビジョンワークショップのエンドツーエンドパイプライン](/img/course/ch10-workshop-vision-pipeline-map-ja.png)
...
![合成ビジョンデータセット生成図](/img/course/ch10-workshop-synthetic-dataset-map-ja.png)
...
![ビジョンワークショップの指標、IoU、混同行列図](/img/course/ch10-workshop-metrics-iou-confusion-map-ja.png)
...
![ビジョンワークショップの失敗例デバッグ図](/img/course/ch10-workshop-failure-debug-map-ja.png)

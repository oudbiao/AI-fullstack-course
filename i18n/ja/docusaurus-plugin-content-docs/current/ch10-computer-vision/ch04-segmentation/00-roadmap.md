...
![Semantic segmentation mask example](/img/course/semantic-segmentation-mask-ja.webp)

![Semantic segmentation IoU and boundary map](/img/course/ch10-semantic-segmentation-iou-boundary-map-ja.webp)

...
### 2.2 なぜインスタンスセグメンテーションは防犯や自動運転に特に向いているのか？
...
![インスタンスセグメンテーションの個体分割、カウント、面積図](/img/course/ch10-instance-segmentation-count-mask-map-ja.png)

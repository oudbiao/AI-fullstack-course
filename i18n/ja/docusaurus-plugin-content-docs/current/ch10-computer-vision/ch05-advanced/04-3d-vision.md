...
### 3.3 初心者が3Dビジョンを学ぶとき、まず覚えるべき3つは？
...
![3D ビジョンの深度、視差、点群の直感図](/img/course/ch10-3d-depth-disparity-pointcloud-map.png)
...
### 5.1 勘違い1：3Dビジョンは「1次元増える」だけ

それだけではありません。  
新しい幾何学的な問題が増えます。

### 5.2 勘違い2：2Dがうまくできれば自然に3Dもできる

役立ちはしますが、空間幾何の直感は別に補う必要があります。

### 5.3 勘違い3：最初から複雑な3Dネットワークを使えばよい
...
### 5.4 最初に3Dプロジェクトをやるときの、いちばん安定した順番

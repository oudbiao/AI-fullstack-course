...
### 1.4 初めて検出プロジェクトをやるとき、どんな題材が安定しやすい？
...
### 2.3 なぜ検出プロジェクトでは「誤検出 / 見逃し」の視点が特に大事なの？
...
### 2.4 初めて検出プロジェクトをやるとき、まず分けるべきミスは？
...
![検出プロジェクトの評価と誤検出・見逃しの分類図](/img/course/ch10-detection-practice-eval-buckets-map.png)
...
### 3.1 アノテーション基準が一致していない

これは学習と評価の両方を一気に乱してしまいます。

### 3.2 小さな対象や遮蔽を個別に分析していない

多くのシステムは、このような場面で性能がはっきり下がります。

### 3.3 きれいな画像を1〜2枚だけ見せる

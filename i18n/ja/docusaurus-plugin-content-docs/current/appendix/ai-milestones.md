...
![AI 歴史の転換点コミック](/img/course/appendix-ai-history-comic-turning-points-ja.png)
...
![AI 論文の問題・方法・影響チェーン](/img/course/appendix-ai-paper-problem-solution-impact-chain-ja.png)
...
![プロジェクト視点で見る AI タイムライン](/img/course/appendix-ai-project-lens-map-ja.png)
...
![3 回のニューラルネットワーク波と 2 回の谷](/img/course/appendix-neural-network-waves-timeline-ja.png)

![古典的機械学習の分岐図](/img/course/appendix-classic-ml-branch-map-ja.png)

![NLP から LLM への系譜図](/img/course/appendix-nlp-llm-lineage-map-ja.png)

![アラインメント、Agent、システム主線図](/img/course/appendix-agent-system-lineage-map-ja.png)

![LLM から Agent へのエンジニアリング進化タイムライン](/img/course/appendix-llm-to-agent-evolution-timeline-ja.png)

![マルチモーダルと AIGC の系譜図](/img/course/appendix-multimodal-aigc-lineage-map-ja.png)

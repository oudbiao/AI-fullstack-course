...
| 9.8 | 評価と安全 | 出力を採点し、危険な action を止め、trace を確認する | trace ログ、安全ブロック、評価ケース |
...
| 層 | いま学ぶこと | どう使うか |
|---|---|---|
| 必修コア | 単一 Agent ループ、tool schema、ホワイトリスト、最大ステップ、state 境界、memory 境界、trace ログ、安全ブロック、評価ケース | 単なる demo ではなく、レビューできる Agent の最小スキルです |

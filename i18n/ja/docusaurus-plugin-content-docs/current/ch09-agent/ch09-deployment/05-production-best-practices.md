...
## まずは最小の readiness チェッカーを動かしてみよう
...
期待される結果：段階的リリース、rollback、alert、audit、手動引き継ぎを README や運用メモに整理し、本番 readiness を説明できる状態です。

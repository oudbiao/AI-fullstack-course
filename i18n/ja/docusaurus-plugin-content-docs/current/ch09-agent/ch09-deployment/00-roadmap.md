...
## 9.9.1.1 まず runtime loop を見る

![Agent production runtime architecture diagram](/img/course/ch09-production-runtime-map-ja.png)

![Agent deployment and operations 章の学習フロー図](/img/course/ch09-deployment-chapter-flow-ja.png)

![Agent deployment observability and recovery loop](/img/course/ch09-deployment-observability-loop-ja.png)

production の問いは「1 回動いたか」ではありません。「動き続け、安全に失敗し、回復できるか」です。

## 9.9.1.2 Deployment readiness check を動かす

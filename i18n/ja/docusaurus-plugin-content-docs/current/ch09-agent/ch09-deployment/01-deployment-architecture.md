---
title: "9.2 Agent デプロイメントアーキテクチャ"
sidebar_position: 49
...
## 一、実運用できる Agent システムには、通常どんな層があるのか？
...
## 二、なぜ「モデル API + いくつかのツール」だけではアーキテクチャとは言えないのか？
...
### 5.4 初めてデプロイ設計をするときの、いちばん安定した順番
...
## 六、いちばん起こしやすいアーキテクチャの落とし穴

### 6.1 落とし穴1：すべてのロジックを1つのサービスに詰め込む
...
### 6.2 落とし穴2：データベースがあれば状態アーキテクチャがあると思う
...
### 6.3 落とし穴3：本番に出してから trace と metrics を足す

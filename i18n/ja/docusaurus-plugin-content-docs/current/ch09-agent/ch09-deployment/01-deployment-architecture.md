...
![Agent デプロイメントアーキテクチャのレイヤー化されたデータフロー図](/img/course/ch09-agent-runtime-state-queue-map-ja.png)
...
3. その後、trace と metrics を追加する
4. 最後に、本当にキューと非同期 worker が必要かを判断する

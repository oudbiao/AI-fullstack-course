...
3. 返金の procedural memory は、注文確認、ポリシー確認、支払い状態確認、不足証拠の質問、対応案作成、高リスク手順の確認、結果ログという checklist にできます。
4. 難しいのは保存そのものではなく、選択と整理です。Agent は何を書くか、何を取り出すか、何を無視するか、memory を現在の回答にどう反映するかを決める必要があります。

...
また、状況ごとの一回限りの出来事を記録する情景記憶とも少し違います。

---

## 三、長期記憶で一番難しいのは「保存」ではなく「更新」

### 3.1 新しい情報が古い情報を覆すことがあるから
...
### 3.4 初学者が最初に覚えるとよい書き込み判断表

| 情報の種類 | 短期向きか長期向きか |
|---|---|
| 今回は少し簡潔にしてほしい | どちらかというと短期 |
| ユーザーは長期的に中国語が好き | どちらかというと長期 |
...
### 4.2 なぜここで `key-value` を使うのが自然なのか？
...
## 五、長期記憶はどう読み出せば「多すぎて乱れる」ことを防げるのか？

### 5.1 読み出し時に全部をコンテキストへ入れない
...
### 5.3 最初に長期記憶システムを作るときの、いちばん堅い順番
...
## 六、もし目標が「知識ベース駆動の教材生成アシスタント」なら、どんな情報を長期記憶に入れるべきか？
...
### 6.1 より実際のプロジェクトらしい長期 profile の例
...
### 7.1 罠1：一度言ったら永久に保存してしまう

これだと、たまたまの好みが永遠に固定されてしまいます。

### 7.2 罠2：長期記憶と短期記憶を分けない

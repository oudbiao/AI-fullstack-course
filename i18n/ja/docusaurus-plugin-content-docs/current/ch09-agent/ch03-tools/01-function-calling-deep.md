---
title: "3.2 Function Calling の詳説"
sidebar_position: 11
...
## 一、なぜ Function Calling を単独で深掘りするのか？

### 1.1 初級版は「呼べるかどうか」だけを解決する
...
### 2.1 Function Calling の標準的な閉ループ
...
## 四、パラメータ検証: モデルを「いつでも正しい呼び出し器」と思ってはいけない
...
## 六、多段階呼び出しで、本当に難しいのはどこか？

### 6.1 難しさは「もう一度呼ぶこと」ではなく、状態管理
...
## 八、Function Calling の深い部分で本当に注目すべきこと

### 8.1 大事なのは「呼べるか」ではなく「安定して呼べるか」

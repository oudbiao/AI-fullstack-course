...
### 1.3 たとえ話：ツール本体は家電、パターンは電源タップや電圧安定器
...
## 三、まずは「組み合わせ可能なツールラッパー」の例を動かしてみよう
...
## 五、いつ一連のツールを「高度なツール」としてまとめるべきか？

### 5.1 組み合わせが十分に固定されているとき
...
### 5.2 Agent に細かいことをあまり考えさせたくないとき
...
## 六、「知識ベース駆動の教材生成アシスタント」を作るなら、どの組み合わせを先にまとめるべきか？
...
### 7.1 誤解1：高度なパターンとは「装飾子をたくさん書くこと」

違います。  
大事なのは見た目の派手さではなく、  
本当に重複する問題を減らせるかどうかです。

### 7.2 誤解2：キャッシュがあれば必ず良い

データの変化が速い場合、  
キャッシュは古い結果のリスクを逆に増やすことがあります。

### 7.3 誤解3：組み合わせが多いほど強いシステムである

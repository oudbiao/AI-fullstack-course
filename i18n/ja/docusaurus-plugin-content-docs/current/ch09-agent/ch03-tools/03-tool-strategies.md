...
## 一、なぜ「ツールがある」ことと「ツールを使える」ことは同じではないのか？
...
### 9.1 ツール呼び出し戦略を「ルーティングルール」だと考える

...
![Agent ガードレールの層構造図](/img/course/agent-guardrails-layers.png)
...
### 6.2 ガードルールが厳しすぎて、正常なリクエストまで大量に弾く

### 6.3 回帰用のテスト集がないままガードを変更する

...
## 一、ローコードプラットフォームの最も核心的な価値は何ですか？

### 1.1 これは「エンジニアを置き換える」ためではない
...
## 二、なぜAgentの場面では特にローコードが出てきやすいのですか？
...
## 四、ローコードプラットフォームはどんなタイプのタスクに向いていますか？
...
## 五、ローコードプラットフォームの最大の強みはどこにありますか？
...
## 六、でも、なぜローコードは過大評価されやすいのでしょうか？

### 6.1 複雑さを自動で消してくれるわけではない

流れが本当に複雑になると、可視化された図もどんどん見づらくなることがあります。

### 6.2 多くの「ローコードシステム」は、最後にはコードに戻る必要がある
...
## 七、とても重要な問題：誰がこのプラットフォームを使うのですか？

### 7.1 主にエンジニアチームだけが使うなら

多くの場合、直接コードフレームワークを使っても問題ありません。

### 7.2 次の役割も一緒に参加してほしいなら
...
### 9.1 ローコードは見た目が速いから、何でもそれで作ってしまう

これは、複雑さが増えたあとに壁にぶつかることが多いです。

### 9.2 立ち上げ速度だけを見て、長期保守を見ない

これが、ローコードが最も過大評価されやすいところです。

### 9.3 ローコードならシステム理解が不要だと思ってしまう

...
## 一、なぜ Agent フレームワークが必要なのか？

### 1.1 フレームワークがないと、自分で書くときに何が大変なのか？
...
## 二、フレームワークの大きな違いは、たいてい「できるかどうか」ではなく「どうやるか」にある

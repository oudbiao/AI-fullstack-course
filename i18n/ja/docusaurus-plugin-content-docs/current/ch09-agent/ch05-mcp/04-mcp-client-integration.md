...
## 一、Client と Server の役割分担はどうなっているのか？
...
## 二、Client が最初に学ぶべきことは？ まずツールを発見すること
...
### 5.1 なぜ client は単なるプロトコル呼び出し器ではないのか？
...
## 六、なぜ client にとってエラー処理が特に重要なのか？

### 6.1 client は「失敗を最初に感じ取る側」だから
...
## 七、なぜ client にもキャッシュが必要なことがあるのか？

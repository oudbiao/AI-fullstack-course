...
## 四、MCP が「ツールのエコシステム化」に特に向いている理由

### 4.1 ツールの世界は本質的に異種混在だから
...
## 五、典型的な導入例 1：IDE と開発ツール

### 5.1 なぜこの場面が特に向いているのか？
...
## 八、エコシステムで一番重要なのは「数」ではなく「互換性」

### 8.1 プロトコルエコシステムで最も大切な価値
...
## 九、MCP エコシステム実践でよくある落とし穴

### 9.1 プロトコルを統一したら、権限問題も自動で解決すると考えてしまう

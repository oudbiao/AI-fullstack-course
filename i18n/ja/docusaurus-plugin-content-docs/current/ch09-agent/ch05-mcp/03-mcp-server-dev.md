...
## 一、MCP Server は実際に何をしているのか？

### 1.1 「もうひとつの普通のバックエンド」ではない
...
## 四、Server の最小2機能：ツール一覧の表示 + ツールの実行
...
## 五、なぜパラメータ検証は server の責任なのか？

### 5.1 client やモデルは、間違ったパラメータを渡すことがあるから
...
## 七、MCP Server 開発でよくある落とし穴

### 7.1 業務ロジックとプロトコルロジックを混ぜてしまう
...
## 八、MCP Server の設計が十分よいかどうかをどう判断するか？

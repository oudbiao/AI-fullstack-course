...
### 1.1 現実のタスクでは「A のあとに B、B のあとに C」とは限らないから
...
### 3.2 なぜ `draft_report` は最後でないといけないのか？
...
### 3.3 worker を 2 から 1 に変えたらどうなるか？
...
![高度なプランニング DAG、並列性、クリティカルパスの図](/img/course/ch09-advanced-planning-dag-critical-path-map.png)
...
### 6.3 落とし穴3：高度なプランニングは常に単純なプランより優れている

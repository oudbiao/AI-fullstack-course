...
## 一、なぜ推論評価は普通の QA より複雑なのか？

### 1.1 推論システムは、ただ1つのテキストを出すだけではないから
...
### 1.3 たとえ話：目的地に着いたかだけでなく、どうやって着いたかも見る
...
### 3.2 なぜ `agent_b` は一見そこまで悪く見えなくても、実際にはもっと悪いのか？
...
### 4.3 Agent タスクでは、アクションが割に合っているかを見る
...
### 7.3 誤解3: 固定 benchmark がなくても、感覚で改善できる

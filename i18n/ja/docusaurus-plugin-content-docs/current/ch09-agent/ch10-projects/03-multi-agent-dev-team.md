---
title: "10.4 プロジェクト：マルチ Agent 開発チーム【選択】"
sidebar_position: 56
...
## 二、まずは役割間のアーティファクト引き継ぎ例を動かしてみよう
...
### 3.1 なぜこのループだけでもかなり実際のプロジェクトに近いのか？
...
### 3.2 reviewer が通らないのに tester が続けないほうがいいのはなぜ？
...
![マルチ Agent 開発チームの成果物ループ図](/img/course/ch09-multi-agent-dev-team-delivery-map.png)

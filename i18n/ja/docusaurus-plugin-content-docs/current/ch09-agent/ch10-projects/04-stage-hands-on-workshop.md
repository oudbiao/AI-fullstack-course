...
![Agent ワークショップ単一 Agent 実行ループ図](/img/course/ch09-workshop-single-agent-loop-flow-map-ja.png)
...
![Agent ワークショップ Tool Schema と権限ゲート](/img/course/ch09-workshop-tool-schema-permission-map-ja.png)
...
![Agent ワークショップ Trace JSONL 復習図](/img/course/ch09-workshop-trace-jsonl-replay-map-ja.png)
...
![Agent ワークショップ評価スコアカード図](/img/course/ch09-workshop-evaluation-scorecard-map-ja.png)

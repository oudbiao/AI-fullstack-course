---
title: "10.2 プロジェクト：インテリジェント研究アシスタント"
sidebar_position: 54
...
### 4.1 この例が「project skeleton の dataclass」より価値があるのはなぜ？
...
### 6.1 検索は合っているのに、要約で重要点が抜ける

### 6.2 要約は自然に読めるのに、出典が合っていない

### 6.3 プロジェクトが「賢そうに見える答え」を1つ見せるだけになっている
...
1. サンプルに文書を1つ追加して、ある query で「関連文書の競合」が起きるようにしてみよう。

...
### 1.1 実際のシステムは、たいてい純粋な理論アーキテクチャではないから
...
### 8.1 パターンを役割数と結びつけてしまう

「Agent が 3 個なら、必ずこのパターン」とは限りません。  
大事なのは数ではなく、責任の関係です。

### 8.2 見た目を複雑にするためにパターンを増やす

---
title: "7.2 マルチ Agent のアーキテクチャパターン"
sidebar_position: 38
...
### 1.2 では、どんなときにマルチ Agent を使う価値があるのか？
...
### 9.1 マルチ Agent を「モデルをたくさん動かせばいいもの」と考える

本当に難しいのは数ではなく、アーキテクチャです。

### 9.2 最初からいちばん自由な協力パターンを選ぶ

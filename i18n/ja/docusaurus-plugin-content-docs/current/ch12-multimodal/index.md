...
![AIGC とマルチモーダルメインビジュアル](/img/course/ch12-multimodal-aigc-ja.png)
...
## 12.0.1 まずマルチモーダルワークフローを見る

![マルチモーダルワークフローループ](/img/course/ch12-multimodal-workflow-loop-ja.svg)
...
## 12.0.4 マルチモーダルを RAG、Agent、創作ワークフローへ接続する

![マルチモーダル RAG、Agent、卒業プロジェクト図](/img/course/ch12-multimodal-rag-agent-capstone-map-ja.svg)

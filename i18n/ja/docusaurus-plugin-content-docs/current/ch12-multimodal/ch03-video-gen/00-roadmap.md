...
## 12.3.1.1 まずタイムラインを見る

![動画、音声、デジタルヒューマン章の学習フロー](/img/course/ch12-video-gen-chapter-flow-ja.png)

![TTS テキスト音声変換パイプライン](/img/course/ch12-tts-text-to-speech-pipeline-map-ja.png)

![デジタルヒューマン同期パイプライン](/img/course/ch12-digital-human-sync-pipeline-map-ja.png)

最初の習慣は、すべての生成素材がタイムラインのどこに置かれるかを説明することです。

## 12.3.1.2 30 秒の素材計画を作る

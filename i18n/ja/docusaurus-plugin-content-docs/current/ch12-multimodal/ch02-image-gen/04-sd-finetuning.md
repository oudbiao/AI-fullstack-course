...
![画像生成の微調整ルート選択図](/img/course/ch12-sd-finetuning-route-choice-map.png)
...
### 5.2 なぜ Textual Inversion より「強い」のか？
...
### 6.1 軽いスタイル用トリガー語がほしいなら

まず考えるのは：

- Textual Inversion

### 6.2 低コストで、差し替え可能で、保守しやすくしたいなら

まず考えるのは：

- LoRA

### 6.3 特定の専用主体に強く結びつけたいなら
...
### 9.1 いきなりフル微調整をやろうとする

多くの場合、そこまで必要ありません。

### 9.2 何を微調整したいのかがはっきりしていない

...
![Stable Diffusion の応用モード選択図](/img/course/ch12-sd-application-mode-selector-map.png)
...
### 9.3 ユーザーの本当の課題は「生成」ではなく「編集」であることが多い

...
![機械翻訳エラー分析図](/img/course/ch11-machine-translation-error-analysis-map.png)
...
### 1.3 なぜこの種類のタスクは Seq2Seq に特に向いているのか？
...
### 2.2 初心者が最初に翻訳プロジェクトを作るとき、どんなデータを選ぶと安定しやすいか？
...
### 3.4 初めて翻訳プロジェクトを作るとき、なぜ baseline が弱いからといって気にしすぎないほうがよいのか？
...
### 4.7 初めて翻訳プロジェクトを作るなら、いちばん安定したエラー分類は何か？
...
### 5.2 注意機構とニューラル Seq2Seq を入れる

### 5.3 さらに進めて Transformer に移る
...
### 6.2 誤解2：きれいな例を1、2個見るだけで十分

本当のプロジェクトでは、系統的なエラー分析のほうが大切です。

### 6.3 誤解3：最初から大きなモデルをそのまま学習すればよい

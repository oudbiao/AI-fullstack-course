...
![Seq2Seq 章の進め方](/img/course/ch11-seq2seq-chapter-flow-ja.png)
...
## 11.5.1.2 生成は 1 token ずつ進む

![Encoder-Decoder のボトルネック](/img/course/ch11-seq2seq-encoder-decoder-bottleneck-map-ja.png)
...
![T5 の text-to-text 統一](/img/course/ch11-t5-text-to-text-task-unification-map-ja.png)

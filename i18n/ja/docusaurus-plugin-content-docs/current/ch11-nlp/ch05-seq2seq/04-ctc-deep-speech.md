...
![CTC の有効経路と折りたたみ結果図](/img/course/ch11-ctc-valid-paths-collapse-result-map-ja.webp)

:::tip CTC の経路数を読む
`15` は score ではありません。4 frame の候補のうち、同じ target に折りたためる経路数です。そのため CTC は、1つの手作業アラインメントなしでも学習できます。
:::

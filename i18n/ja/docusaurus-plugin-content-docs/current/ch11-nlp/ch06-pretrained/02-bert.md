...
### 4.1 もっとも有名なタスク：Masked Language Modeling
...
### 7.3 BERT をプロジェクトに入れるとき、何を最初に見せるべきか
...
### 9.1 理由は「役に立たなかった」からではなく、発展が続いたから
...
### 10.1 BERT と GPT を同じものだと思ってしまう

どちらも重要ですが、学習目標も得意なタスクも違います。

### 10.2 `[CLS]` を「自動的に最良の文ベクトル」だと思ってしまう

多くのタスクでは便利ですが、どこでも万能というわけではありません。

### 10.3 「BERT で分類した」だけで、何を学んでいるのかを理解していない

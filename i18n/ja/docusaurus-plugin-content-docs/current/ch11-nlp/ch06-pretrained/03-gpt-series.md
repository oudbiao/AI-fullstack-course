...
![GPT 自己回帰生成図](/img/course/gpt-autoregressive-generation.png)
...
### 5.2 オフラインでランダム初期化した小型 GPT の形を見てみる
...
### 6.1 GPT はなぜ「その場でルールを学ぶ」ように見えるのか？
...
### 9.1 GPT は「会話できるモデル」だと思ってしまう

会話は表面の姿です。  
根っこは自己回帰言語モデリングです。

### 9.2 学習時にも GPT は双方向に文脈を見られると思ってしまう

違います。  
GPT の重要な制約は、未来を見てはいけないことです。

### 9.3 「モデルが大きい」ことだけ知っていて、出力テンソルが何を表すか分からない

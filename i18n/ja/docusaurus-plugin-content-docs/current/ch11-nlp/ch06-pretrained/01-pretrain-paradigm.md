...
### 初めて事前学習パラダイムを学ぶとき、最初に押さえるべきことは？
...
```text
['返金'] -> ('refund', {'refund': 1.0, 'invoice': 0.2, 'password': 0.1})
['請求書'] -> ('invoice', {'refund': 0.3, 'invoice': 1.0, 'password': 0.1})

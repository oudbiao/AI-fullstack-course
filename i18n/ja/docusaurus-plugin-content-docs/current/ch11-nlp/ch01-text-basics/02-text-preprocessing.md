...
![テキスト前処理パイプライン図](/img/course/text-preprocessing-pipeline.png)
...
## 8. 伝統的なモデルと事前学習済みモデルでは、なぜ前処理の考え方が違うのか？
...
### 8.1 初めて NLP プロジェクトを作るときの、いちばん安全な順番

...
### 3.4 さらに、最小限の「文脈の窓が表現に影響する」例を見る
...
### 6.1 誤解1: 文脈化された表現は「もっと大きい単語ベクトル」なだけ
...
### 6.2 誤解2: 同じ単語でも違うベクトルになるのは細かい改善にすぎない

そうではありません。  
これは多くのタスクの上限を本当に変える一歩です。

### 6.3 誤解3: 文脈化された表現があれば、上位のモデリングはもう不要

...
### 1.1 one-hot は身分しか区別できず、関係を表せない
...
### 2.1 基本仮説：文脈が似ていれば、意味も似ていることが多い
...
### 2.4 なぜ「分布が似ている」ことが NLP の主流を変えるのか？
...
### 4.5 初めて embedding をプロジェクトに入れるときの、いちばん安全な使い方
...
### 5.1 誤解1：単語埋め込みは辞書の意味そのもの

違います。  
これは辞書の定義表ではなく、統計的な意味空間に近いものです。

### 5.2 誤解2：単語ベクトルが学習できれば何でも解決する

単語埋め込みは、基本的な意味関係しか表しません。  
多義語や複雑な文脈では、すぐに足りなくなります。

### 5.3 誤解3：単語だけを見て、タスクを見ない

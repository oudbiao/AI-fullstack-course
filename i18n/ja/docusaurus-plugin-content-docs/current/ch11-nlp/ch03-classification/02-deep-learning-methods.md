...
### 3.1 この例が、単に `nn.Sequential` より役立つ理由
...
### 5.2 明示的なキーワードより意味が重要なとき

キーワードだけでは判定しにくいなら、  
深い表現を使う価値があります。

### 5.3 より高い学習コストを受け入れられるとき
...
### 5.4 初めてテキスト分類プロジェクトを作るときの、いちばん堅い順番

...
### 1.1 最初の要約プロジェクトで、どう題材を選ぶと安定するか？
...
### 4.2 なぜ要約プロジェクトでは途中のスコアを見せるとよいのか？

---
title: "3.3.1 Pandas 入門：この章では何を学ぶのか"
sidebar_position: 8
...
| 章節 | 一番解決したい問題 |
|---|---|
| [3.3.2 Pandas の中核データ構造](./01-core-structures.md) | まず `Series / DataFrame / Index` が何かを理解する |
| [3.3.3 データの読み書き](./02-read-write.md) | CSV / Excel / JSON を読み込み、書き出す |
| [3.3.4 データの選択と絞り込み](./03-selection-filter.md) | 本当に欲しい部分のデータを取り出す |
| [3.3.5 データクリーニング](./04-data-cleaning.md) | 欠損値、重複、異常値、形式の問題を処理する |
| [3.3.6 データ変換](./05-data-transform.md) | 列どうしの変換、マッピング、派生を行う |
| [3.3.7 分组与聚合](./06-groupby.md) | 「部署別 / 月別 / カテゴリ別」の集計分析を行う |
| [3.3.8 データ結合](./07-merge.md) | 複数の表をつなげる |
| [3.3.9 时间序列](./08-time-series.md) | 表を時間の観点で扱えるようにする |

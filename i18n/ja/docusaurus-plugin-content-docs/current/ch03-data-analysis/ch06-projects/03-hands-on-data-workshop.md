---
title: "6.3 ハンズオンワークショップ：再現可能なデータ分析パイプラインを作る"
sidebar_position: 27
...
# ハンズオンワークショップ：再現可能なデータ分析パイプラインを作る

![ハンズオン型データワークショップのルート](/img/course/ch03-hands-on-data-workshop-route-ja.png)
...
## Step 1：コードを書く前にパイプラインを見る

![クリーニングと検証のパイプライン](/img/course/ch03-hands-on-cleaning-pipeline-ja.png)
...
![グループ集計と SQLite の流れ](/img/course/ch03-hands-on-groupby-sql-flow-ja.png)
...
![グラフとレポート出力の流れ](/img/course/ch03-hands-on-chart-report-flow-ja.png)
...
![証拠パックのチェックリスト](/img/course/ch03-hands-on-evidence-pack-ja.png)

...
### 誤解その一：先に複雑な UI を作ってからバックエンドにつなぐ
...
### 誤解その二：読み込み状態とエラー状態がない

これでは体験がとても悪くなり、  
しかも問題の切り分けも難しくなります。

### 誤解その三：フロントエンドを「飾り」と考える

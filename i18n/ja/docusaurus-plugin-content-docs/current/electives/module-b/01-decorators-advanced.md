...
### 1.1 多くの処理が、いろいろな関数の外側に繰り返し付くから
...
### 6.1 誤解その1：装飾器を見るとすぐ「上級者向け」と思ってしまう

装飾器は見せびらかすための技術ではなく、  
重複を減らすための仕組みです。

### 6.2 誤解その2：装飾器を何層も重ねすぎる

1つの関数に装飾器がたくさん付くと、  
デバッグも理解も難しくなります。

### 6.3 誤解その3：`wraps` を使わない

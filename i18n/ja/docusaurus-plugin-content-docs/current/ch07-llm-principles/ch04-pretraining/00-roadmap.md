...
## 7.4.1.1 まず事前学習の三角形を見る

![事前学習章関係図](/img/course/ch07-pretraining-chapter-flow-ja.png)

![事前学習データ、目的、エンジニアリング三角図](/img/course/ch07-pretraining-data-objective-engineering-map-ja.png)

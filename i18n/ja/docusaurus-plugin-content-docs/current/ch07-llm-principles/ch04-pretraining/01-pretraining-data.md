...
### 1.1 モデルが学ぶのは知識だけではなく、言語の癖や世界の分布でもある
...
### 1.2 たとえ話：基礎の質が、その後のすべての仕上げの上限を決める
...
### 1.3 なぜ「インターネットは巨大」でも「そのまま学習に使える」とは限らないのか？
...
### 1.4 事前学習データを初めて学ぶとき、まず何をつかむべきか？
...
### 2.1 カバレッジ：モデルがどれだけ多様な言語や知識に触れられるか
...
### 2.2 品質：すべての token が同じ価値を持つわけではない
...
### 2.4 安全性とコンプライアンス：「見てから考える」では遅い内容もある
...
### 2.5 データガバナンスを初めて見るなら、まず何を覚えるべきか？
...
### 4.1 ソースごとの token は、それぞれ違う能力を育てる
...
### 7.3 誤解3：後で微調整するから、事前学習データはあまり気にしなくてよい

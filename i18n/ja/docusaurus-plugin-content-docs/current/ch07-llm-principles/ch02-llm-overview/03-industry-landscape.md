...
![LLM 産業構造のレイヤーマップ](/img/course/ch07-llm-industry-landscape-map-ja.png)
...
### 1.2 プラットフォーム層：誰がモデルを使いやすくしているのか？
...
### 1.3 初学者向け用語メモ：プラットフォーム層でよく出る言葉
...
### 2.1 アプリケーション層が売っているのはモデルではなく、結果
...
### 3.1 クローズドソースモデルは「すぐ使える成熟したエンジン」に近い
...
### 3.2 オープンソースモデルは「自分で改造できるエンジン」に近い
...
### 4.2 なぜ同じモデルでも、製品によって体験が大きく違うのか？

---
title: "3.2 Transformer アーキテクチャの振り返りと深掘り"
sidebar_position: 8
...
### 1.1 解いているのは「系列の中で誰が誰を見るべきか」という問題
...
### 1.2 Transformer の本当に強いところは attention だけではない
...
### 1.3 たとえ話: 各 block は「議論 + 整理」みたいなもの
...
### 2.3 self-attention は「token をまたいだ交流」を担当する
...
### 2.4 前馈ネットワークは「単独の token を深く加工する」
...
![Transformer Block データフロー分解図](/img/course/ch07-transformer-block-dataflow-map-ja.png)
...
### 3.1 このコードを読むときは、まず 4 つの場所に注目する
...
### 3.3 なぜ attention の後に FFN が必要なのか？
...
### 4.1 多層に積むということは、抽象化を段階的に進めるということ
...
### 4.2 Encoder と Decoder の違いは、主に mask と相互作用の仕方
...
### 5.2 block 構造はシンプルに見えても、訓練は簡単ではない
...
### 5.3 block を理解すると、その後の多くの章が楽になる
...
### 6.1 誤解 1: Transformer = attention
...
### 6.3 誤解 3: QKV が分かれば Transformer を理解したことになる

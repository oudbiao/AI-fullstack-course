...
![RLHF 三段階の流れ図](/img/course/rlhf-three-stage-loop.png)
...
![RLHF 報酬モデルと KL 制約の閉ループ図](/img/course/ch07-rlhf-reward-kl-loop-map.png)
...
### 6.1 誤解1：RLHF は「人間のフィードバックを少し足す」だけ
...
### 6.2 誤解2：報酬モデルのスコアが高ければ、実際にもっと良い回答である

報酬モデルは、人間の嗜好を近似する代理にすぎません。  
そのため、盲点や偏りがあります。

### 6.3 誤解3：RLHF は SFT より常に上位なので、標準で使うべき

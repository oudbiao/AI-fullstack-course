...
### 2.1 Helpful：助けるべき場面では、ちゃんと役に立つ
...
### 2.2 Honest：分からないなら分からないと言う。知ったかぶりしない
...
### 2.3 Harmless：やってはいけないことは、きちんと止める
...
### 3.1 目標のズレ：モデルが最適化しているのは、あなたの心の基準ではない
...
### 3.2 データ分布の変化：本番の質問は、学習データよりずっと汚い
...
### 6.1 誤解1：アライメントとは安全フィルタのことだ

違います。  
システムが拒否ばかりするなら、  
安全かもしれませんが、まったく使いやすくありません。

### 6.2 誤解2：アライメント問題を全部モデルに押し付けること
...
### 6.3 誤解3：「すごく本当っぽく話す」なら良い回答だと思うこと

...
![DPO と RLHF の嗜好最適化ショートカット図](/img/course/ch07-dpo-rlhf-shortcut-map-ja.webp)

:::tip 図の読み方
この図は、まず RLHF の長い流れを見ると分かりやすいです。嗜好ペア -> 報酬モデル -> PPO / 方策最適化、という流れです。次に DPO の短い流れを見ると、chosen / rejected の嗜好ペアを直接使って方策の差分を最適化していることが分かります。DPO の魅力は、嗜好学習の目的を保ちながら、報酬モデルと強化学習の大きな実装複雑性を削れる点にあります。
:::

...
### 1.2 たとえ話：モデルはラベル名を学ぶのではなく、その背後のルールを学ぶ
...
### 2.3 いつ分類ラベルにするべきか、いつペア比較にするべきか？
...
![データラベリング品質チェックとフライホイール回帰図](/img/course/ch07-data-labeling-flywheel-review-map-ja.png)
...
### 7.1 誤解1：先に大量にラベル付けして、ルールは後で考える

ルールが固まっていないのに大規模にラベル付けを始めると、  
やり直しが非常に多くなりがちです。

### 7.2 誤解2：一致率だけを見て、争いの原因を見ない
...
### 7.3 誤解3：フライホイールを「もっとデータを増やし続けること」だと思う

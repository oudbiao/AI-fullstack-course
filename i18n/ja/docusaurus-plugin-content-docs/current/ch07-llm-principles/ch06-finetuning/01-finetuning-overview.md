...
flowchart LR
    ...
    C --> C1["コストが低い<br/>まず baseline を作るのに向いている"]
...
### 7.2 誤解2：微調整すればモデルが「知識ベースを覚える」と思うこと

微調整は振る舞いを形づくるのに向いています。  
高速に更新される知識を入れる方法として、いつも最適とは限りません。

### 7.3 誤解3：学習さえすれば必ず強くなると思うこと
...
### 8.1 初めてのプロジェクトで一番安定した進め方

実際にタスクを形にしたいなら、次の順番がおすすめです。

1. まず Prompt で baseline を作る
2. 次に検索やワークフローで第2の baseline を作る

...
![LoRA パラメータ更新の比較図](/img/course/lora-parameter-update.png)
...
![LoRA と QLoRA の低ランク増分とメモリ節約の図](/img/course/ch07-lora-qlora-low-rank-memory-map.png)
...
## 5. QLoRA はさらに何を解決するのか？

### 5.1 LoRA だけでは、なぜ十分でないことがあるのか？
...
## 6. LoRA と QLoRA は、それぞれいつ向いているのか？
...
## 7. なぜ、これらがファインチューニングのハードルを変えたのか？
...
### 8.1 LoRA / QLoRA を「代償なしの強化」だと思うこと

確かに強力ですが、完全にコストゼロではありません。

### 8.2 QLoRA を使えばリソースを気にしなくてよいと思うこと

軽くはなりますが、無限に軽くなるわけではありません。

### 8.3 方法名だけ覚えて、何を変えているのか理解しないこと

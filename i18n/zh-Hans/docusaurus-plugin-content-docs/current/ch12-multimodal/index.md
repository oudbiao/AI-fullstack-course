...
如果你想在选择更大的毕业项目之前先跑一个 baseline，请先完成 [实操：构建一个可复现的多模态创意包](./ch05-projects/02-hands-on-multimodal-workshop.md)。它会用本地脚本生成创意 brief、Prompt 记录、SVG 视觉资产、分镜文件、审核报告、失败案例和导出预览。

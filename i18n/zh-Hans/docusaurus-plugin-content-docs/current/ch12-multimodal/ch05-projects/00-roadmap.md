...
![AIGC 创意平台项目交付闭环图](/img/course/ch12-projects-delivery-loop.png)

![创意内容包流程图](/img/course/ch12-workshop-creative-package-pipeline-map.png)

![提示词、素材与版本图](/img/course/ch12-workshop-prompt-asset-version-map.png)

![审核与导出图](/img/course/ch12-workshop-review-export-map.png)

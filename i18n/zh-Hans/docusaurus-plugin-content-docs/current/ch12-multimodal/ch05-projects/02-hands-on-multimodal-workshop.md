...
![多模态创意包流水线图](/img/course/ch12-workshop-creative-package-pipeline-map.png)
...
![Prompt 到资产版本记录图](/img/course/ch12-workshop-prompt-asset-version-map.png)
...
![审核与导出流程图](/img/course/ch12-workshop-review-export-map.png)
...
![多模态失败样本排查图](/img/course/ch12-workshop-failure-debug-map.png)

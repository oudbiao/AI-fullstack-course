...
![视频、语音与数字人章节学习流程图](/img/course/ch12-video-gen-chapter-flow.png)

![TTS 文本到语音流程图](/img/course/ch12-tts-text-to-speech-pipeline-map.png)

![数字人同步流程图](/img/course/ch12-digital-human-sync-pipeline-map.png)

先养成一个习惯：每个生成素材都要说明它在时间线上的位置。

## 12.3.1.2 建一个 30 秒素材计划

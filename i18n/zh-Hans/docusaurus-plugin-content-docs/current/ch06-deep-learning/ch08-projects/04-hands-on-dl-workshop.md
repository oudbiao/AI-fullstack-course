...
![PyTorch shape 与数据划分护栏](/img/course/ch06-hands-on-shape-split-guardrail.png)

### 1.1 先建立心智模型：一张图、一个 batch、三份数据
...
![Dataset 到 DataLoader 批处理流程](/img/course/ch06-hands-on-dataset-dataloader-batch-flow.png)
...
![PyTorch 训练循环解剖图](/img/course/ch06-hands-on-training-loop-anatomy.png)
...
![深度学习输出文件阅读实验室](/img/course/ch06-hands-on-output-reading-lab.png)
...
![PyTorch 小步重跑实验闭环](/img/course/ch06-hands-on-rerun-experiment-loop.png)

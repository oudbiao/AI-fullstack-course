---
title: "学习指南与任务单：AI Agent 与智能体系统怎么学最不容易学乱"
sidebar_position: 1
...
# 学习指南与任务单：AI Agent 与智能体系统怎么学最不容易学乱
...
在几个大项目之间做选择前，建议先跑一遍 [可追踪单 Agent 实操工作坊](./ch10-projects/04-stage-hands-on-workshop.md)。它是本阶段 baseline：一个 Agent、几个工具、权限检查、trace 日志和固定评估用例。

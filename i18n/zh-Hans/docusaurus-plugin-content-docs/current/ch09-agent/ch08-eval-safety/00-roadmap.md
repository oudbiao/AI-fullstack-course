...
![Agent guardrails 分层图](/img/course/agent-guardrails-layers.png)

![Agent 评估与安全章节学习流程图](/img/course/ch09-eval-safety-chapter-flow.png)

![Agent 风险调试闭环图](/img/course/ch09-agent-risk-debug-loop.png)

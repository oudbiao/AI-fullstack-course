...
sidebar_position: 26
description: "从客户端-服务器关系、工具暴露、消息流转到传输层，系统理解一个 MCP 系统内部是怎样工作的。"
...
:::tip 读图提示
这张图按消息顺序看：Host 里的客户端先向服务器请求 tools/list，拿到能力清单后再发起 tools/call。MCP 的价值在于让“发现能力”和“调用能力”有统一协议。
:::

...
![Agent 工具使用章节学习顺序图](/img/course/ch09-tools-chapter-flow.png)

## 学这一章时要抓住的主线

这一章的主线可以概括为：工具调用不是“模型想调就调”，而是“在受控边界内把计划转成动作”。

![Agent 工具受控调用闭环图](/img/course/ch09-tool-control-loop.png)

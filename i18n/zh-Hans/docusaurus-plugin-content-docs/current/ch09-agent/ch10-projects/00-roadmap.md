---
title: "9.10.1 学前导读：综合项目这一章到底该怎么学"
sidebar_position: 0
...
推荐的第一个可运行例子是 [9.10.5 实操：构建一个可追踪的单 Agent 助手](./04-stage-hands-on-workshop.md)。如果你想先建立一个关于规划、工具、trace、权限拦截和评估的具体 baseline，请在几个大项目页之前先运行它。

...
3. 退款的 procedural memory 可以是：核对订单、检查政策、确认支付状态、补齐缺失证据、提出动作、确认高风险步骤、记录结果。
4. 难点不只是存储，而是选择和组织：Agent 要判断写什么、取什么、忽略什么，以及 memory 应如何影响当前回答。

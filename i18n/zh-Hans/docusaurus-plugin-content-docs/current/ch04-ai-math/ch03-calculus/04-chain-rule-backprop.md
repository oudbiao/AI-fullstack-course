...
![链式法则计算示例分步图](/img/course/ch04-chain-rule-calculation-example.png)
...
![多层链式法则路径图](/img/course/ch04-chain-rule-multilayer.png)
...
![前向传播保存中间值示意图](/img/course/ch04-chain-rule-forward-pass.png)
...
![反向传播把梯度从损失传回参数](/img/course/ch04-chain-rule-backward-pass.png)
...
![用梯度和学习率更新参数](/img/course/ch04-chain-rule-parameter-update.png)
...
![小神经网络完整训练循环](/img/course/ch04-chain-rule-full-training-loop.png)

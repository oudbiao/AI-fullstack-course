...
![矩阵线性变换网格图](/img/course/matrix-linear-transform-grid.png)
...
![矩阵批量变换流程图](/img/course/ch04-matrix-batch-transform-flow.png)

...
| 章节 | 它最该帮你解决什么问题 |
|---|---|
| [3.5.2 关系型数据库基础](./01-relational-db.md) | 先搞懂数据库、表、主键、外键到底是什么 |
| [3.5.3 SQL 基础](./02-sql-basics.md) | 学会用 SQL 把数据查出来、筛出来、按组统计 |
| [3.5.4 Python 数据库操作](./03-python-db.md) | 让 Python、Pandas 和数据库真正接起来 |
| [3.5.5 数据库设计](./04-db-design.md) | 理解表为什么要那样拆、字段为什么要那样设计 |

## 第一次学这一章，最稳的顺序

更稳的顺序通常是：

1. 先学 [3.5.2 关系型数据库基础](./01-relational-db.md)
   先把数据库和表的概念立起来。
2. 再学 [3.5.3 SQL 基础](./02-sql-basics.md)
   先会查、会筛、会分组。
3. 再学 [3.5.4 Python 数据库操作](./03-python-db.md)
   让代码和数据库接起来。
4. 最后再看 [3.5.5 数据库设计](./04-db-design.md)
   让你知道为什么表要那样组织。

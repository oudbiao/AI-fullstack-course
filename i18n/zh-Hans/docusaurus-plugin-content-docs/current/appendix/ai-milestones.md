...
![AI 历史转折点漫画](/img/course/appendix-ai-history-comic-turning-points.png)
...
![AI 论文：问题、方法、影响链条](/img/course/appendix-ai-paper-problem-solution-impact-chain.png)
...
![从项目视角看 AI 时间线](/img/course/appendix-ai-project-lens-map.png)
...
![三次神经网络浪潮与两次低谷时间线](/img/course/appendix-neural-network-waves-timeline.png)

![经典机器学习分支图](/img/course/appendix-classic-ml-branch-map.png)

![NLP 到 LLM 演进图](/img/course/appendix-nlp-llm-lineage-map.png)

![对齐、Agent 与系统主线图](/img/course/appendix-agent-system-lineage-map.png)

![从 LLM 到 Agent 的工程演进时间线](/img/course/appendix-llm-to-agent-evolution-timeline.png)

![多模态与 AIGC 演进图](/img/course/appendix-multimodal-aigc-lineage-map.png)

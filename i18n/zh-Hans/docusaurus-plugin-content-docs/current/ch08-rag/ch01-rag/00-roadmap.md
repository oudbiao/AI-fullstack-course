...
你已经在第 7 章学过大模型原理、Prompt、微调和对齐。到第 8 章，课程开始从“理解模型能力”进入“组织应用系统”。RAG 是这条应用主线的第一块关键地基。
...
![RAG 从资料到答案流水线图](/img/course/ch08-rag-data-to-answer-pipeline.png)

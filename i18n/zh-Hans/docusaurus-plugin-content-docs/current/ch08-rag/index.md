...
如果你想有人带着做，先完成 [8.5 实操：第 8 章 RAG 应用完整工作坊](./ch05-projects/05-stage-hands-on-workshop.md)。它用一个可运行脚本串起 chunk、metadata、检索、权限、引用、无答案处理、trace 和小型评估集。
...
这个实验的更完整跟做版在 [8.5 实操：第 8 章 RAG 应用完整工作坊](./ch05-projects/05-stage-hands-on-workshop.md)。建议把它当作做作品集 RAG 助手前的最小可运行项目。

---
title: "8.5.1 学前导读：综合项目这一章到底该怎么学"
sidebar_position: 0
...
如果你还没有可运行 baseline，先从 [8.5.6 实操：第 8 章 RAG 应用完整工作坊](./05-stage-hands-on-workshop.md) 开始。它给出本章出口项目的最小可复现版本，然后再接真实向量数据库或模型 API。

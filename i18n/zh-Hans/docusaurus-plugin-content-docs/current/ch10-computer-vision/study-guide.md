...
在选择更大的项目之前，建议先跑一遍 [10.6.4 可复现视觉迷你流水线](./ch06-projects/03-hands-on-vision-workshop.md)。它是本阶段 baseline：一个脚本、合成图像、分类、框、mask、指标和失败样本。

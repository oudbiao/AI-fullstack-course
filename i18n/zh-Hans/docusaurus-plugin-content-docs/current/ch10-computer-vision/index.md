...
10.1 节学习 CV 基础与 OpenCV，理解图像像素、颜色空间、滤波、边缘、形态学和基础图像处理。

10.2 节学习图像分类进阶，包括数据增强、现代分类架构和训练技巧。

10.3 节学习目标检测，理解候选框、类别、置信度、IoU、mAP 和 YOLO 系列。

10.4 节学习图像分割，理解语义分割、实例分割和像素级输出。

10.5 节学习进阶专题，包括人脸检测、视频分析、OCR 和 3D 视觉。

10.6 节完成综合项目，把数据、模型、指标和应用场景连起来。
...
如果你想在选择大项目之前先跑一个 baseline，请先完成 [10.6.4 实操：构建一个可复现的视觉迷你流水线](./ch06-projects/03-hands-on-vision-workshop.md)。它会用本地脚本生成图像、mask、框、指标、预测可视化和失败报告。

如果你想看更细的学习节奏，可以阅读 [10.0 学习指南：计算机视觉怎么学最不容易学乱](./study-guide.md)。

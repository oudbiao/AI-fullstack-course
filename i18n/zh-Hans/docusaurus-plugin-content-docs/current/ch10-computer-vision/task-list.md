...
如果你想先跟着跑通一次，请完成 [实操：构建一个可复现的视觉迷你流水线](./ch06-projects/03-hands-on-vision-workshop.md)。把里面的 `cv_workshop_run/data/labels.csv`、`outputs/` 和 `reports/failure_cases.md` 作为本阶段最低交付证据。

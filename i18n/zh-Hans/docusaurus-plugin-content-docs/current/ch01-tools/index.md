...
如果你希望按完整步骤跟做，可以直接进入 [1.4 跟做工作坊：构建可复现的 AI 学习工作台](ch04-workshop/01-hands-on-tools-workshop.md)。它会把阶段项目拆成一个本地仓库、一段可运行的 Python 检查脚本、Git 提交、排障记录和报告文件。
...
| 推荐通关 | 完成本阶段至少一个可运行小项目，优先完成 1.4 跟做工作坊，并在 README 中记录运行方式、示例输入输出和遇到的问题。 |

...
在选择自己的项目变体之前，先完成 [2.5 跟做工作坊：构建本地学习任务助手](./ch03-projects/05-hands-on-python-workshop.md)。它提供固定命令、预期输出、生成文件和调试清单，让你不用猜下一步，就能练完整 Python 项目闭环。
...
| 2.5 跟做工作坊 | 1～2 小时 | 做出并运行一个完整 CLI、JSON、统计和报告流程 |

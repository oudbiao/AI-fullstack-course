...
![CLI 命令执行流程](/img/course/ch02-hands-on-cli-command-flow.png)
...
![JSON 持久化流程](/img/course/ch02-hands-on-json-persistence-flow.png)
...
![错误与调试地图](/img/course/ch02-hands-on-error-debug-map.png)
...
![Python 项目证据包](/img/course/ch02-hands-on-evidence-pack.png)

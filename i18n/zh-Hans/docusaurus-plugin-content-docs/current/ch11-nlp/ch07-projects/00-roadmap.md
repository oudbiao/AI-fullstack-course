...
推荐的第一个可运行例子是 [11.7.6 实操：构建一个可复现的 NLP 迷你流水线](./05-hands-on-nlp-workshop.md)。如果你想先建立一个关于文本数据、tokenization、TF-IDF、分类、检索问答、摘要、抽取、指标和失败分析的具体 baseline，请在几个大项目页之前先运行它。

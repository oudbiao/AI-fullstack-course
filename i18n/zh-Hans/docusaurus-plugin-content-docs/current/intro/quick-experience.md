---
sidebar_position: 0
title: "0.1 30 分钟 AI 工程体验"
description: "极短的 AI 工程初体验：比较输入变化，观察模型输出，准备环境前先留下证据。"
keywords: [AI 工程体验, AI 快速体验, Google Colab, 图像识别, 文本生成, AI 入门]
---
...
对比记录：一个输入变化，以及它造成的输出差异
概念链接：后面哪一章解释隐藏机制
失败检查：API key、依赖、网络、Prompt 或输出格式问题
期望产出：一条很小但可检查的 AI 行为记录
```

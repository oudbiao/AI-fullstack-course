---
title: "学习指南与任务单：大模型原理、Prompt 与微调怎么学最不容易学乱"
sidebar_position: 1
...
# 学习指南与任务单：大模型原理、Prompt 与微调怎么学最不容易学乱
...
第六轮再跑 [实操：第 7 章完整工作坊](./ch08-projects/03-stage-hands-on-workshop.md)。这时工作坊是复盘实验室：把 token、Prompt 评测、结构化校验和方案选择串成一次完整运行。

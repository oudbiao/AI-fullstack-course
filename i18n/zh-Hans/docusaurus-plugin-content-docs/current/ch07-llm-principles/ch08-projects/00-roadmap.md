...
如果你在设计自己的领域项目前需要一条带着走的起步路线，可以先跑 [7.8.4 实操：第 7 章完整工作坊](./03-stage-hands-on-workshop.md)。它提供完整的离线练习闭环，包括固定样本、Prompt 版本通过率、结构化输出失败和方案路线记录。

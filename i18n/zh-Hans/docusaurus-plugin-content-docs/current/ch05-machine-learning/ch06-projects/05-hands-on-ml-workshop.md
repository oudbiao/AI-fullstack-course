---
title: "6.6 实操工作坊：构建可复现的 ML 证据包"
sidebar_position: 23
description: "第 5 章机器学习综合实操：把 baseline、Pipeline、指标、阈值、错误分析和 README 证据串成一个可运行项目。"
keywords: [机器学习实操, sklearn pipeline, baseline, 模型评估, 错误分析, 作品集]
---

# 实操工作坊：构建可复现的 ML 证据包

![第 5 章机器学习实操路线图](/img/course/ch05-hands-on-ml-workshop-route.png)
...
![训练测试划分实操护栏](/img/course/ch05-hands-on-data-split-lab.png)
...
![机器学习证据流水线](/img/course/ch05-hands-on-evidence-pipeline.png)
...
![机器学习工作坊代码执行顺序图](/img/course/ch05-hands-on-code-execution-sequence.png)
...
### 4.2 创建 `ml_workshop.py`

![ColumnTransformer 与 Pipeline 训练流程](/img/course/ch05-hands-on-pipeline-training-flow.png)
...
![阈值与指标决策实验](/img/course/ch05-hands-on-threshold-decision-lab.png)
...
![错误样本分桶复盘](/img/course/ch05-hands-on-error-bucket-review.png)
...
![机器学习工作坊泄漏与调试闭环图](/img/course/ch05-hands-on-debug-loop.png)
...
![机器学习作品集证据包](/img/course/ch05-hands-on-portfolio-pack.png)

![机器学习工作坊实验复跑闭环](/img/course/ch05-hands-on-rerun-experiment-loop.png)

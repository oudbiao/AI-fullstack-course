---
title: "5.6.1 学前导读：项目实战这一章到底该怎么学"
sidebar_position: 18
...
:::info 大项目之前的引导练习
如果这条项目闭环还比较抽象，可以先跑 [5.6.6 实操工作坊：构建可复现的 ML 证据包](./05-hands-on-ml-workshop.md)。它会在房价、客户流失、用户分群和 Kaggle 项目前，给你一次完整可运行的项目彩排。
:::

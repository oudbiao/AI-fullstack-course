...
![Bagging 与 Boosting 对比图](/img/course/ch05-ensemble-bagging-boosting-flow.png)
...
![GBDT 残差修正漫画](/img/course/ch05-ensemble-gbdt-residual-correction.png)
...
![防泄漏 Stacking 工作流漫画](/img/course/ch05-ensemble-stacking-leakage-safe.png)

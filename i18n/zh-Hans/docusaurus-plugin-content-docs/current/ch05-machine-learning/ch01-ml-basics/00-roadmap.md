...
如果你想把“为什么这些算法会出现”先看顺，可以先读 [5.1.2 机器学习历史突破主线](./04-history-breakthroughs.md)。它会把 Bayes、MLE、EM、线性模型、决策树、SVM、随机森林、Boosting、XGBoost 和 sklearn 分配到对应学习章节。
